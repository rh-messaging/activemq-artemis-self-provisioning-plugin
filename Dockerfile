...
LABEL description="Red Hat AMQ 7.14.1 Self Provisioning Plugin"
LABEL maintainer="Red Hat, Inc."
LABEL version="7.14.1"
LABEL summary="Red Hat AMQ 7.14.1 Self Provisioning Plugin"
LABEL amq.broker.version="7.14.1.SPP.1.CR3"
LABEL com.redhat.component="amq-broker-self-provisioning-plugin-rhel9-container"
LABEL io.k8s.display-name="Red Hat AMQ 7.14.1 Self Provisioning Plugin"
