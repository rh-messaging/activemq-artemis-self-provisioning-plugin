FROM registry-proxy.engineering.redhat.com/rh-osbs/rhacm2-yarn-builder@sha256:834bc58c8727cd899d7873778a4865fb81e2404a4cb6e5f172e14143f24ba793 AS build-image
