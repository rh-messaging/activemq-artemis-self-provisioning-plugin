...
LABEL description="Red Hat AMQ 7.13.5 Self Provisioning Plugin"
LABEL maintainer="Roderick Kieley <rkieley@redhat.com>"
LABEL version="7.13.5"
LABEL summary="Red Hat AMQ 7.13.5 Self Provisioning Plugin"
LABEL amq.broker.version="7.13.5.SPP.1.CR1"
LABEL com.redhat.component="amq-broker-self-provisioning-plugin-rhel9-container"
LABEL io.k8s.display-name="Red Hat AMQ 7.13.5 Self Provisioning Plugin"
