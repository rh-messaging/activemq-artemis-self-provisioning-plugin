...
LABEL summary="Red Hat AMQ 7.14.0 Self Provisioning Plugin"
LABEL amq.broker.version="7.14.0.SPP.1.CR1"
LABEL com.redhat.component="amq-broker-self-provisioning-plugin-rhel9-container"
LABEL io.k8s.display-name="Red Hat AMQ 7.14.0 Self Provisioning Plugin"
